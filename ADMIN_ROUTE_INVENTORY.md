...
| --- | --- | --- | --- | --- | --- |
| `/admin?section=control` | Overview KPIs, attention, pipeline, system summary, quick actions, scoped search | `GET /api/v1/admin/overview`, `GET /api/v1/admin/operations/overview`, `GET /api/v1/admin/risk-operations`, review/lifecycle reads | Contextual links only | Admin workspace | Read-only implementation; fresh authenticated retest required |
