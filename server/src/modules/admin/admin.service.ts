        ...
        return {
          ...
          nextAction: demoIntake
            ...
            : demoEligible
              ...
              : intake
                ? nextIntakeAction(intake)
                : 'Await vault selection',
          allowedActions,
          issues,
          testFixture:
            Boolean(demoIntake) ||
    ...
    return {
      ...
      complianceSummary: {
        kycStatus: complianceAccess
          ? (kycCase?.status ?? 'UNKNOWN')
          : 'UNAVAILABLE',
        kytStatus: complianceAccess
          ? (kytCase?.status ?? 'UNKNOWN')
          : 'UNAVAILABLE',
