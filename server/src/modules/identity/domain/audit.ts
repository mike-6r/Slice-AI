...
const metadataKeys: Record<string, readonly string[]> = {
  ...
  ADMIN_ACCOUNT_REPAIR_ACCOUNT_STATE: [
    'source',
    'reason',
    'incidentReference',
    'affected',
  ],
  ADMIN_ACCOUNT_REFRESH_DERIVED_ACCESS: [
    'source',
    'reason',
    'incidentReference',
    'affected',
  ],
  ADMIN_ACCOUNT_RECONCILE_ROLES_CAPABILITIES: [
    'source',
    'reason',
    'incidentReference',
    'affected',
  ],
  ADMIN_ACCOUNT_REVOKE_BROKEN_SESSIONS: [
    'source',
    'reason',
    'incidentReference',
    'affected',
  ...
  CERT_PROVIDER_VERIFICATION_RECORDED: [
    'verificationId',
    'companyCode',
    'status',
    'providerReference',
  ...
  PRE_SALE_OPENED: ['reason'],
  RESERVATION_CREATED: ['reason'],
  PRE_SALE_CONFIGURED: ['reason'],
  DEADLINE_EXTENDED: ['reason'],
  FINALIZATION_COMPLETED: ['reason'],
  PRE_SALE_PAUSED: ['reason'],
  PRE_SALE_RESUMED: ['reason'],
  ...
  WALLET_RETURN_DEFICIT_CREATED: ['amountMinor', 'reasonCode'],
  WALLET_RETURN_RESERVATIONS_HELD: ['activeReservationCount'],
  PLATFORM_REVENUE_SETTLEMENT_REQUESTED: [
  ...
  PLATFORM_REVENUE_SETTLEMENT_APPROVED: [
    'requestedByUserId',
    'reason',
    'externalStatus',
    'approvalFingerprint',
